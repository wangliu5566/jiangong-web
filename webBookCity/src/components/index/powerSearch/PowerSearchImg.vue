  ...
  <div class="power-search">
    ...
    <div class='power-content'>
      ...
      <div class="menus">
        ...
        <span class="click-this" @click="$router.push('/wrap/searchImg')">图片</span>
        <!-- <span @click="$router.push('/wrap/searchChapter')">章节</span> -->
      </div>
      <div class="index-wrap">
        <el-form ref="form" :model="sizeForm" label-width="110px">
          <el-form-item label="图片名称：" @keyup.enter.native="searchCourse()">
            <el-input v-model="sizeForm.Title" style="width: 322px"></el-input>
          </el-form-item>
          <el-form-item label="作　　者：" @keyup.enter.native="searchCourse()">
...
export default {
  ...
  mounted() {
    this.getlist()
    this.getMenulist('BuildingImg',this.getType)
  },
  methods: {
    searchCourse() {
