  ...
  <div class="power-search">
    ...
    <div class='power-content'>
      ...
      <div class="menus">
        ...
        <span class="click-this" @click="$router.push('/wrap/searchVideo')">视频</span>
      ...
      <div class="index-wrap">
        <el-form ref="form" :model="sizeForm" label-width="110px">
          <el-form-item label="视 频 名 称 ：" @keyup.enter.native="searchCourse()">
            <el-input v-model="sizeForm.Title" style="width: 322px"></el-input>
          </el-form-item>
          <el-form-item label="作者/讲题师：" @keyup.enter.native="searchCourse()">
