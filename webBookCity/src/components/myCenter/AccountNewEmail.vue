   ...
   <!-- logo搜索部分 -->
    ...
    <div class="account-right">
        ...
        <ul class="account-center">
            <li>
                <img src="../../assets/imagesMy-Center/35.png">
                <div class="form-box">
                    <el-form label-position="right" ref="formIn" :model="form" label-width="100px":rules="regRules" >
        ...
        methods: {
            next(formName) {
                this.$refs[formName].validate((valid) => {
                        ...
                        this.$http.post('/User/UpdateMobileOrEmail', {
                            ...
                            .then((res) => {
                                if (res.data.Code == 200) {
                                    this.$router.push("successBindEmail")
                 ...
                 this.$router.push("successVerifyEmail")
            },
            getcode() {
