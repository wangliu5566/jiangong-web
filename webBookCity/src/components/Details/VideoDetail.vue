        ...
        <div class="book-intro" v-show="detailsData.Id" style="margin-left: 470px;">
          ...
          <div class="book-intro-main">
            <div class="book-intro-header">
              <p class="intro-header">
                {{detailsData.Abstracts?detailsData.Abstracts:''}}
              </p>
              <p>
                <span>讲师：{{detailsData.Author?detailsData.Author:'-'}}</span>
                <span>时长：-</span>
              </p>
            </div>
          ...
          <div class="handle-container">
            ...
            <div class="pull-right">
              <el-button type="button" class="handle-btn no-margin gray-red" v-if="detailsData.ExtendData.IsOrdered" @click="readResource">立即观看</el-button>
            </div>
          </div>
        </div>
      </div>
