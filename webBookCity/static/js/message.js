 function Message(messageBoxEle,messageTypeImgEle,messageTextEle) {
           ...
           this.showMessage = function(type,text) {
           	    switch(type) {
           	    	...
           	    	case 'error' :
           	    		...
           	    		break;
           	    	case 'warming' :
           	    		this.messageType.src = this.warming;
           	    		break;
           	    	default:
           	    	    break;			
           	    }
		        ...
		        this.messageAnimate({opacity:100,top:20,zIndex:999});
		        ...
		        this.clearTime = setTimeout(function(){
                   _this.messageAnimate({opacity:0,top:0,zIndex:-1});
		        },2000)
		    }
		   ...
		   this.messageAnimate = function(json,fn) {
                ...
                //每次调用清除已有定时器
                //设置一个变量来保存运动是否到达终点的布尔值；
                  obj.setTime = setInterval(function(){
	                //将定时器绑定到对象的属性上,下次调用才能清除,可去掉obj做试验
